"""Bieu do Plotly mau phan Quan (6 loai theo README) de ban giao cho Khang tich hop dashboard.
Chay: python3 scripts/plotly_quan_samples.py  ->  eda/quan/plotly/*.html
"""
...
def main():
    ...
    world = world[world["country"] == "World"].sort_values("year")
    world = world[(world["year"] >= 1970) & (world["year"] <= 2024)]

    figs = {}
    # 1. Line/area: CO2 toan cau
    ...
    # 2. Horizontal bar: top 15 nam 2023
    ...
    # 4. Stacked area: co cau nganh toan cau
    ...
    # 5. Treemap: ty trong nganh nam gan nhat cua EDGAR
    ...
    # 6. Scatter: CO2/nguoi vs tai tao 2023
